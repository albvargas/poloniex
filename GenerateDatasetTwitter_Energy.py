...
if __name__ == '__main__':
    ...
    lst_words=["Pacific Gas & Electric","@PGE4Me","Southern California Edison","@SCE","Florida Power & Light","@FPL_Newsroom","Consolidated Edison","@ConEdison","@ORUConnect","Georgia Power","@GeorgiaPower","Virginia Electric & Power","@MyCVEC","DTE Energy","@DTE_Energy","Public Service Elec & Gas","@PSEGNews","Duke Energy Carolinas","@DukeEnergy","Consumers Energy","@ConsumersEnergy"]

    f_twi=open("/home/albvargas/poloniex/EnergyTweets.txt","a")
    while True:
        try:
