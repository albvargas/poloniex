...
if __name__ == '__main__':
    ...
    lst_words=["@amazon","@AmazonHelp","amazon","@RakutenUS","@AskRakutenUS","Rakuten","@BestBuy","@BBYNews","Best Buy","@Walmart","@PeopleOfWaImart","Walmart","@Macys","Macys"]

    f_twi=open("/home/albvargas/poloniex/EcommerceTweets.txt","a")
    while True:
        try:
